...
func TestCopyFixed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "01", args: args{dst: testing.T{}}, wantErr: true},
		{name: "02", args: args{src: testing.B{}}, wantErr: true},
		{name: "03", args: args{src: testing.F{}, dst: testing.M{}}, wantErr: true},
		{name: "04", args: args{src: [1]byte{1}, dst: [1]byte{}}, wantErr: true},
		{name: "05", args: args{src: [1]byte{1}, dst: &([2]byte{})}, wantErr: true},
		{name: "1",
